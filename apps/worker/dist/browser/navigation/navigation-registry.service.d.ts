...
export declare class NavigationRegistry {
    ...
    private readonly cucasNavigator;
    private readonly genericNavigator;
    constructor(zzuNavigator: ZzuNavigator, sduNavigator: SduNavigator, cucasNavigator: CucasNavigator, genericNavigator: GenericNavigator);
