...
@Injectable()
export class SessionHealthCheckProcessor implements OnModuleInit, OnModuleDestroy {
  ...
  async onModuleInit() {
    ...
    const intervalMs =
      Number(process.env.SESSION_HEALTH_CHECK_INTERVAL_MS) || DEFAULT_INTERVAL_MS;
