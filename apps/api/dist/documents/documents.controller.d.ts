...
import type { CreateDocumentInput, ReorderDocumentsInput, UpdateDocumentInput, UploadedDocumentFile } from './types/document-api.types.js';
export declare class DocumentsController {
    ...
    upload(studentId: string, type: string | undefined, file: UploadedDocumentFile | undefined): Promise<import("./types/document-api.types.js").StudentDocumentResponse>;
    ...
    reorder(studentId: string, body: ReorderDocumentsInput): Promise<import("./types/document-api.types.js").StudentDocumentResponse[]>;
