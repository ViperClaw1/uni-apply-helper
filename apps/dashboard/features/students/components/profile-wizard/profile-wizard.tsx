...
import { GuarantorStep } from "./guarantor-step";
...
export function ProfileWizard({
  ...
  useEffect(() => {
    ...
    const load = studentId ? getStudentProfile(studentId) : getMyProfile();
...
export function toPersonalInput(profile: StudentProfile | null): MyProfileInput {
...
export function toEducationInput(profile: StudentProfile | null): MyEducationInput {
...
export function toGuarantorInput(profile: StudentProfile | null): MyGuarantorInput {
...
export function toEmergencyContactInput(
...
export function toFamilyInput(profile: StudentProfile | null): MyFamilyInput {
